# This script converts the parent data package knb-lter-vcr.67 into the
...
path <- 'C:/Users/Colin/Documents/EDI/data_sets/ecocomDP/edi_356'
parent_pkg_id <- 'knb-lter-vcr.67.20'
child_pkg_id <- 'edi.356.1'

# Convert to ecocomDP

message('Creating ecocomDP tables')

convert_vcr67_to_ecocomDP(path, parent_pkg_id, child_pkg_id)
...
ecocomDP::make_eml(
  data.path = path,
  code.path = path,
  code.files = c('convert_vcr67_to_ecocomDP.R', 'package_edi356.R'),
