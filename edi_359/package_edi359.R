# This script converts the parent data package knb-lter-and.4781 into the
...
path <- '/Users/csmith/Documents/EDI/datasets/ecocomDP/edi_359'
parent_pkg_id <- 'knb-lter-and.4781.2'
child_pkg_id <- 'edi.359.1'

# Convert to ecocomDP

message('Creating ecocomDP tables')

convert_and4781_to_ecocomDP(path, parent_pkg_id, child_pkg_id)
...
ecocomDP::make_eml(
  data.path = path,
  code.path = path,
  code.files = c('convert_and4781_to_ecocomDP.R', 'package_edi359.R'),
