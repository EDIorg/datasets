# This script converts the parent data package knb-lter-knz.69 into the
...
path <- 'C:/Users/Colin/Documents/EDI/data_sets/ecocomDP/edi_342'
parent_pkg_id <- 'knb-lter-knz.69.15'
child_pkg_id <- 'edi.342.1'

# Convert to ecocomDP

message('Creating ecocomDP tables')

convert_knz69_to_ecocomDP(path, parent_pkg_id, child_pkg_id)
...
ecocomDP::make_eml(
  data.path = path,
  code.path = path,
  code.files = c('convert_knz69_to_ecocomDP.R', 'package_edi342.R'),
