...
path <- 'C:/Users/Colin/Documents/EDI/data_sets/ecocomDP/edi_330'
parent_pkg_id <- 'knb-lter-sgs.520.8'
child_pkg_id <- 'edi.330.1'

# Convert to ecocomDP

message('Creating ecocomDP tables')

convert_sgs520_to_ecocomDP(path, parent_pkg_id, child_pkg_id)
