# This script converts the parent data package knb-lter-sgs.521 into the
...
path <- 'C:/Users/Colin/Documents/EDI/data_sets/ecocomDP/edi_331'
parent_pkg_id <- 'knb-lter-sgs.521.7'
child_pkg_id <- 'edi.331.1'

# Convert to ecocomDP

message('Creating ecocomDP tables')

convert_sgs521_to_ecocomDP(path, parent_pkg_id, child_pkg_id)
...
ecocomDP::make_eml(
  data.path = path,
  code.path = path,
  code.files = c('convert_sgs521_to_ecocomDP.R', 'package_edi331.R'),
