...
dataset_title <- "Data describing how four different levels of induced plant defenses change cannibalism among larval lepidopterans and alter consumption of plant tissue by larval lepidopterans."
...
dataset_name <- "spodoptera_herbivory_cannibalism"
...
keywords = c("plant induced defense",
             "cannibalism",
             "tomato",
             "beet armyworm",
...
geographic_location <- "Zoology Department, Birge Hall, University of Wisconsin-Madison"

coordinate_north <- 43.074444

coordinate_east <- -89.403611

coordinate_south <- 43.074444

coordinate_west <- -89.403611
...
funding_title = "No grant funds were used for this research."

funding_grants = "No grant funds were used for this research."
...
table_names <- c("spodoptera_herbivory_cannibalism_ex1.csv",
                 "spodoptera_herbivory_cannibalism_ex2.csv",
                 "spodoptera_herbivory_cannibalism_ex3.csv")
...
data_table_descriptions <- c("Spodoptera herbivory cannibalism data experiment 1",
                             "Spodoptera herbivory cannibalism data experiment 2",
                             "Spodoptera herbivory cannibalism data experiment 3")
...
data_table_urls <- c("https://lter.limnology.wisc.edu/sites/default/files/data/spodoptera_herbivory_cannibalism/spodoptera_herbivory_cannibalism_ex1.csv",
                     "https://lter.limnology.wisc.edu/sites/default/files/data/spodoptera_herbivory_cannibalism/spodoptera_herbivory_cannibalism_ex2.csv",
                     "https://lter.limnology.wisc.edu/sites/default/files/data/spodoptera_herbivory_cannibalism/spodoptera_herbivory_cannibalism_ex3.csv")
