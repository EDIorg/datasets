...
path <- 'C:\\Users\\Colin\\Documents\\EDI\\data_sets\\villanova_peatland_group\\edi_369\\metadata_templates'
data.path <- 'C:\\Users\\Colin\\Documents\\EDI\\data_sets\\villanova_peatland_group\\edi_369\\data'
eml.path <- 'C:\\Users\\Colin\\Documents\\EDI\\data_sets\\villanova_peatland_group\\edi_369\\eml'
...
EMLassemblyline::import_templates(
  path = path,
  data.path = data.path,
  data.files = 'Shrub_growth_data.csv',
  license = 'CC0'
)
...
EMLassemblyline::make_eml(
  ...
  data.path = data.path,
  eml.path = eml.path,
  dataset.title = 'Shrub Growth, NPP, and Nitrogen Assimilation for Two Years in an Alberta Peatland Subjected to Increasing Nitrogen Deposition, 2014-2015',
  data.files = 'Shrub_growth_data.csv',
  data.files.description = 'Shrub Growth Data',
  temporal.coverage = c('2014-07-01', '2015-07-01'),
