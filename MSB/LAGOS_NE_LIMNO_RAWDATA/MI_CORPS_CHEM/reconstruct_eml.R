...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_CORPS_CHEM"
dataset.name <- "MI_CORPS_CHEM"
table.name <- "MI_CORPS_CHEM.csv"
xml.file.name <- "MI_CORPS_CHEM.xml"

data.package.id <- "edi.22.1"
