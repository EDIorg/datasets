...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\CT_DEEP_SECCHI"
dataset.name <- "CT_DEEP_SECCHI"
table.name <- "CT_DEEP_SECCHI.csv"
xml.file.name <- "CT_DEEP_SECCHI.xml"

data.package.id <- "edi.66.2"
