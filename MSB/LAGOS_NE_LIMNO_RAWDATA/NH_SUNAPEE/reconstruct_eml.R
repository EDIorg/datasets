...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\NH_SUNAPEE"
dataset.name <- "NH_SUNAPEE"
table.name <- "NH_SUNAPEE.csv"
xml.file.name <- "NH_SUNAPEE.xml"

data.package.id <- "edi.67.2"
