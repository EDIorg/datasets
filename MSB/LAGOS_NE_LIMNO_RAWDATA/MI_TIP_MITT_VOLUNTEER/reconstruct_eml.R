...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_TIP_MITT_VOLUNTEER"
dataset.name <- "MI_TIP_MITT_VOLUNTEER"
table.name <- "MI_TIP_MITT_VOLUNTEER.csv"
xml.file.name <- "MI_TIP_MITT_VOLUNTEER.xml"

data.package.id <- "edi.30.1"
