...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MA_QUABBIN_CHEM"
dataset.name <- "MA_QUABBIN_CHEM"
table.name <- "MA_QUABBIN_CHEM.csv"
xml.file.name <- "MA_QUABBIN_CHEM.xml"

data.package.id <- "edi.17.1"
