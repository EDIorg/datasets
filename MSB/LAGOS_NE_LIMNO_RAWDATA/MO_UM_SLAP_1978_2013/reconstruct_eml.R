...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MO_UM_SLAP_1978_2013"
dataset.name <- "MO_UM_SLAP_1978_2013"
table.name <- "MO_UM_SLAP_1978_2013.csv"
xml.file.name <- "MO_UM_SLAP_1978_2013.xml"

data.package.id <- "edi.35.1"
