...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\CT_POST_CHL"
dataset.name <- "CT_POST_CHL"
table.name <- "CT_POST_CHL.csv"
xml.file.name <- "CT_POST_CHL.xml"


data.package.id <- "edi.12.1"
