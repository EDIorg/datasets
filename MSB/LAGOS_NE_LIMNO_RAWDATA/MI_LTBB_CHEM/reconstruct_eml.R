...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_LTBB_CHEM"
dataset.name <- "MI_LTBB_CHEM"
table.name <- "MI_LTBB_CHEM.csv"
xml.file.name <- "MI_LTBB_CHEM.xml"
