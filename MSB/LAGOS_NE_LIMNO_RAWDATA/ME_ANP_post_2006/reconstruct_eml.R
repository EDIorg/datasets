...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\ME_ANP_post_2006"
dataset.name <- "ME_ANP_post_2006"
table.name <- "ME_ANP_post_2006.csv"
xml.file.name <- "ME_ANP_post_2006.xml"

data.package.id <- "edi.20.1"
