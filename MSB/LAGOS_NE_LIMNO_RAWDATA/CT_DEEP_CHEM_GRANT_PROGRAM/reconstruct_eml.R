...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\CT_DEEP_CHEM_GRANT_PROGRAM"

data.package.id <- "edi.10.2"

table_names <- trimws(c("CT_DEEP_CHEM_GRANT_PROGRAM.csv"))
