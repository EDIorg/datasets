...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\EPA_TIME_CHEM"
dataset.name <- "EPA_TIME_CHEM"
table.name <- "EPA_TIME_CHEM.csv"
xml.file.name <- "EPA_TIME_CHEM.xml"

data.package.id <- "edi.65.2"
