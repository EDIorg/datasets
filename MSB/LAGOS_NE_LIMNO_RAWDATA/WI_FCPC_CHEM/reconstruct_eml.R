...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\WI_FCPC_CHEM"
dataset.name <- "WI_FCPC_CHEM"
table.name <- "WI_FCPC_CHEM.csv"
xml.file.name <- "WI_FCPC_CHEM.xml"

data.package.id <- "edi.75.2"
