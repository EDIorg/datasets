...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_TMDL_PLATTE_CHEM"
dataset.name <- "MI_TMDL_PLATTE_CHEM"
table.name <- "MI_TMDL_PLATTE_CHEM.csv"
xml.file.name <- "MI_TMDL_PLATTE_CHEM.xml"

data.package.id <- "edi.50.1"
