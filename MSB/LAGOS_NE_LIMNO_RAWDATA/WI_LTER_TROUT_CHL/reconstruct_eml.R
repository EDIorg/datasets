...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\WI_LTER_TROUT_CHL"
dataset.name <- "WI_LTER_TROUT_CHL"
table.name <- "WI_LTER_TROUT_CHL.csv"
xml.file.name <- "WI_LTER_TROUT_CHL.xml"

data.package.id <- "edi.45.1"
