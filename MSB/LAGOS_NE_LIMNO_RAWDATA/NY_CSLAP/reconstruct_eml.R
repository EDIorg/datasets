...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\NY_CSLAP"
dataset.name <- "NY_CSLAP"
table.name <- "NY_CSLAP.csv"
xml.file.name <- "NY_CSLAP.xml"

data.package.id <- "edi.39.1"
