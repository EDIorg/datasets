...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\CT_DEEP_CHEM"
dataset.name <- "CT_DEEP_CHEM"
table.name <- "CT_DEEP_CHEM.csv"
xml.file.name <- "CT_DEEP_CHEM.xml"

data.package.id <- "edi.54.1"
