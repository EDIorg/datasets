...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_MSU_LNDSCP_CHEM"
dataset.name <- "MI_MSU_LNDSCP_CHEM"
table.name <- "MI_MSU_LNDSCP_CHEM.csv"
xml.file.name <- "MI_MSU_LNDSCP_CHEM.xml"

data.package.id <- "edi.26.1"
