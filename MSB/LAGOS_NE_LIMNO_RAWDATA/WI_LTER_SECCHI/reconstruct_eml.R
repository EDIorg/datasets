...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\WI_LTER_SECCHI"
dataset.name <- "WI_LTER_SECCHI"
table.name <- "WI_LTER_SECCHI.csv"
xml.file.name <- "WI_LTER_SECCHI.xml"

data.package.id <- "edi.44.2"
