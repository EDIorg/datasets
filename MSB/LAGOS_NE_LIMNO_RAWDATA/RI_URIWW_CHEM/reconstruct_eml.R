...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\RI_URIWW_CHEM"
dataset.name <- "RI_URIWW_CHEM"
table.name <- "RI_URIWW_CHEM.csv"
xml.file.name <- "RI_URIWW_CHEM.xml"

data.package.id <- "edi.41.1"
