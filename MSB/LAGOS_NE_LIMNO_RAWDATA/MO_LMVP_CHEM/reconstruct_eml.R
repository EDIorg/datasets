...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MO_LMVP_CHEM"
dataset.name <- "MO_LMVP_CHEM"
table.name <- "MO_LMVP_CHEM.csv"
xml.file.name <- "MO_LMVP_CHEM.xml"

data.package.id <- "edi.34.1"
