...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_PAUL"
dataset.name <- "MI_PAUL"
table.name <- "MI_PAUL.csv"
xml.file.name <- "MI_PAUL.xml"

data.package.id <- "edi.28.1"
