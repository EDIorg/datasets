...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MN_GPR_CHEM"
dataset.name <- "MN_GPR_CHEM"
table.name <- "MN_GPR_CHEM.csv"
xml.file.name <- "MN_GPR_CHEM.xml"

data.package.id <- "edi.53.1"
