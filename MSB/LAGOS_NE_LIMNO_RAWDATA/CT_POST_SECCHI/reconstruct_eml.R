...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\CT_POST_SECCHI"
dataset.name <- "CT_POST_SECCHI"
table.name <- "CT_POST_SECCHI.csv"
xml.file.name <- "CT_POST_SECCHI.xml"


data.package.id <- "edi.14.1"
