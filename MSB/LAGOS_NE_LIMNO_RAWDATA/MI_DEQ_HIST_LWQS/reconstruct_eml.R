...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_DEQ_HIST_LWQS"
dataset.name <- "MI_DEQ_HIST_LWQS"
table.name <- "MI_DEQ_HIST_LWQS.csv"
xml.file.name <- "MI_DEQ_HIST_LWQS.xml"

data.package.id <- "edi.93.2"
