...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\WI_DNR_NUTRIENT"
dataset.name <- "WI_DNR_NUTRIENT"
table.name <- "WI_DNR_NUTRIENT.csv"
xml.file.name <- "WI_DNR_NUTRIENT.xml"

data.package.id <- "edi.74.3"
