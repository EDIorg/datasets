...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\EPA_NLA_CHEM"
dataset.name <- "EPA_NLA_CHEM"
table.name <- "EPA_NLA_CHEM.csv"
xml.file.name <- "EPA_NLA_CHEM.xml"

data.package.id <- "edi.48.1"
