...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MN_MPCA_CHEM_1999_2012"
dataset.name <- "MN_MPCA_CHEM_1999_2012"
table.name <- "MN_MPCA_CHEM_1999_2012.csv"
xml.file.name <- "MN_MPCA_CHEM_1999_2012.xml"

data.package.id <- "edi.51.1"
