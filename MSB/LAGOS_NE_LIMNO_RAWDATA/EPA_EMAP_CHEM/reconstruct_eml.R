...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\EPA_EMAP_CHEM"
dataset.name <- "EPA_EMAP_CHEM"
table.name <- "EPA_EMAP_CHEM.csv"
xml.file.name <- "EPA_EMAP_CHEM.xml"

data.package.id <- "edi.46.1"
