...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\NY_CDEP_CATSKILL"
dataset.name <- "NY_CDEP_CATSKILL"
table.name <- "NY_CDEP_CATSKILL.csv"
xml.file.name <- "NY_CDEP_CATSKILL.xml"

data.package.id <- "edi.38.1"
