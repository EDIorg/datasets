...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MN_MPCA_SECCHI"
dataset.name <- "MN_MPCA_SECCHI"
table.name <- "MN_MPCA_SECCHI.csv"
xml.file.name <- "MN_MPCA_SECCHI.xml"

data.package.id <- "edi.31.1"
