...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MA_DEP_CHEM"
dataset.name <- "MA_DEP_CHEM"
table.name <- "MA_DEP_CHEM.csv"
xml.file.name <- "MA_DEP_CHEM.xml"

data.package.id <- "edi.72.2"
