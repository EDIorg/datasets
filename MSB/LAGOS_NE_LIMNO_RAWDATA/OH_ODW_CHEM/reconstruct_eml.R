...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\OH_ODW_CHEM"
dataset.name <- "OH_ODW_CHEM"
table.name <- "OH_ODW_CHEM.csv"
xml.file.name <- "OH_ODW_CHEM.xml"

data.package.id <- "edi.40.1"
