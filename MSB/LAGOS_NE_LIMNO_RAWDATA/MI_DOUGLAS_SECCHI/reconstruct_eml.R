...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_DOUGLAS_SECCHI"
dataset.name <- "MI_DOUGLAS_SECCHI"
table.name <- "MI_DOUGLAS_SECCHI.csv"
xml.file.name <- "MI_DOUGLAS_SECCHI.xml"

data.package.id <- "edi.24.1"
