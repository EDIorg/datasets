...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MN_MPCA_CHEM"
dataset.name <- "MN_MPCA_CHEM"
table.name <- "MN_MPCA_CHEM.csv"
xml.file.name <- "MN_MPCA_CHEM.xml"

data.package.id <- "edi.47.1"
