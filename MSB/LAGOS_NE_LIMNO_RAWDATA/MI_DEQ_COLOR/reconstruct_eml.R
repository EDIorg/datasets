...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_DEQ_COLOR"
dataset.name <- "MI_DEQ_COLOR"
table.name <- "MI_DEQ_COLOR.csv"
xml.file.name <- "MI_DEQ_COLOR.xml"

data.package.id <- "edi.23.1"
