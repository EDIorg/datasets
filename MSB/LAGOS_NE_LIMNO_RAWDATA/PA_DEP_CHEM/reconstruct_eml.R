...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\PA_DEP_CHEM"
dataset.name <- "PA_DEP_CHEM"
table.name <- "PA_DEP_CHEM.csv"
xml.file.name <- "PA_DEP_CHEM.xml"

data.package.id <- "edi.73.2"
