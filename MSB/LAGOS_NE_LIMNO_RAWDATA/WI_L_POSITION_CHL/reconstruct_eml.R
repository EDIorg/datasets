...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\WI_L_POSITION_CHL"
dataset.name <- "WI_L_POSITION_CHL"
table.name <- "WI_L_POSITION_CHL.csv"
xml.file.name <- "WI_L_POSITION_CHL.xml"

data.package.id <- "edi.77.2"
