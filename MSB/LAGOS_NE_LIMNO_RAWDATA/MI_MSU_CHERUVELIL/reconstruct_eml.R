...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_MSU_CHERUVELIL"
dataset.name <- "MI_MSU_CHERUVELIL"
table.name <- "MI_MSU_CHERUVELIL.csv"
xml.file.name <- "MI_MSU_CHERUVELIL.xml"

data.package.id <- "edi.92.2"
