...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MN_SHINGOBEE_SECHHI"
dataset.name <- "MN_SHINGOBEE_SECHHI"
table.name <- "MN_SHINGOBEE_SECHHI.csv"
xml.file.name <- "MN_SHINGOBEE_SECHHI.xml"

data.package.id <- "edi.32.1"
