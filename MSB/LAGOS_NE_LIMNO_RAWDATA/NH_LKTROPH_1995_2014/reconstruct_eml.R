...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\NH_LKTROPH_1995_2014"
dataset.name <- "NH_LKTROPH_1995_2014"
table.name <- "NH_LKTROPH_1995_2014.csv"
xml.file.name <- "NH_LKTROPH_1995_2014.xml"

data.package.id <- "edi.52.1"
