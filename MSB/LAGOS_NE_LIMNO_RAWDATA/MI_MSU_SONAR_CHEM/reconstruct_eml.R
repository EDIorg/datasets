...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_MSU_SONAR_CHEM"
dataset.name <- "MI_MSU_SONAR_CHEM"
table.name <- "MI_MSU_SONAR_CHEM.csv"
xml.file.name <- "MI_MSU_SONAR_CHEM.xml"

data.package.id <- "edi.27.1"
