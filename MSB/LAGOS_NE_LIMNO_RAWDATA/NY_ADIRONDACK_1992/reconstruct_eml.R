...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\NY_ADIRONDACK_1992"
dataset.name <- "NY_ADIRONDACK_1992"
table.name <- "NY_ADIRONDACK_1992.csv"
xml.file.name <- "NY_ADIRONDACK_1992.xml"

data.package.id <- "edi.37.1"
