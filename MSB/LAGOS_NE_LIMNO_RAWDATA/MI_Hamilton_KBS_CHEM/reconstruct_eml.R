...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_Hamilton_KBS_CHEM"
dataset.name <- "MI_Hamilton_KBS_CHEM"
table.name <- "MI_Hamilton_KBS_CHEM.csv"
xml.file.name <- "MI_Hamilton_KBS_CHEM.xml"

data.package.id <- "edi.25.1"
