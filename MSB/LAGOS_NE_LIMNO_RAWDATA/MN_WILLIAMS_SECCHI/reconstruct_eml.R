...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MN_WILLIAMS_SECCHI"
dataset.name <- "MN_WILLIAMS_SECCHI"
table.name <- "MN_WILLIAMS_SECCHI.csv"
xml.file.name <- "MN_WILLIAMS_SECCHI.xml"

data.package.id <- "edi.33.1"
