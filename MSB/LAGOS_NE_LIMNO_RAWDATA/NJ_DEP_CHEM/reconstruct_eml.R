...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\NJ_DEP_CHEM"
dataset.name <- "NJ_DEP_CHEM"
table.name <- "NJ_DEP_CHEM.csv"
xml.file.name <- "NJ_DEP_CHEM.xml"

data.package.id <- "edi.36.1"
