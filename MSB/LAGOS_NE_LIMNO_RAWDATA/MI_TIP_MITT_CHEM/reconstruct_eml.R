...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MI_TIP_MITT_CHEM"
dataset.name <- "MI_TIP_MITT_CHEM"
table.name <- "MI_TIP_MITT_CHEM.csv"
xml.file.name <- "MI_TIP_MITT_CHEM.xml"

data.package.id <- "edi.29.1"
