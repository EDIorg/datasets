...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MA_QUABBIN_SECCHI"
dataset.name <- "MA_QUABBIN_SECCHI"
table.name <- "MA_QUABBIN_SECCHI.csv"
xml.file.name <- "MA_QUABBIN_SECCHI.xml"

data.package.id <- "edi.19.1"
