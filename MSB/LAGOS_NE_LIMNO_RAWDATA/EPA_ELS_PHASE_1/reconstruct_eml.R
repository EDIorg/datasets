...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\EPA_ELS_PHASE_I"
dataset.name <- "EPA_ELS_PHASE_I"
table.name <- "EPA_ELS_PHASE_I.csv"
xml.file.name <- "EPA_ELS_PHASE_I.xml"

data.package.id <- "edi.71.2"
