...
path <- "C:\\Users\\Colin\\Documents\\EDI\\data_sets\\msb_csi_lagos\\MA_WACHUSETT_CHEM"
dataset.name <- "MA_WACHUSETT_CHEM"
table.name <- "MA_WACHUSETT_CHEM.csv"
xml.file.name <- "MA_WACHUSETT_CHEM.xml"

data.package.id <- "edi.49.1"
